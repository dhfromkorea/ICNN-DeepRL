...
ax = plt.gca()
ax.plot(np.log10(lamdas), accuracy_list, marker='o', linestyle='--', c='b')
ax.scatter(np.log10(lamdas[best_lamda]), accuracy_list[best_lamda], marker='x', c='g', s=500.0)
ax.set_xlabel('Lamda(logarithm to the base 10)')
