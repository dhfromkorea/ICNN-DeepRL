...
flags.DEFINE_integer('l2size', 128, '2nd layer size')
...
flags.DEFINE_float('l2norm', 0.01, 'l2 weight decay')
flags.DEFINE_float('pl2norm', 0.01, 'policy network l2 weight decay (only for DDPG)')
flags.DEFINE_float('rate', 0.01, 'learning rate')
flags.DEFINE_float('prate', 0.01, 'policy net learning rate (only for DDPG)')
