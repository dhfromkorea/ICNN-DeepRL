...
do
    ...
    python3 main.py --model ICNN --env $env --outdir output --total_episode $total_episode --train_episode 5 \
...
do
    ...
    python3 main.py --model DDPG --env $env --outdir output --total_episode $total_episode --train_episode 5 \
...
do
    ...
    python3 main.py --model NAF --env $env --outdir output --total_episode $total_episode --train_episode 5 \
